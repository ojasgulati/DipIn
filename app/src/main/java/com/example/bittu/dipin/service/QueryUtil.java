...
public class QueryUtil {
    ...
    public static JSONArray fetchJsonArray(Context context) {
        ...
        try {
            ...
            URL baseUrl = new URL(prefs.getString(context.getString(R.string.pref_shared_platform), "https://newsapi.org/v1/articles?source=bbc-news&apiKey=")); // GET YOUR OWN API at https://newsapi.org/
